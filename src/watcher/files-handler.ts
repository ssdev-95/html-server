...
export function copyFolder(currentDir:string, destinationDir:string) {
  fs.readdir(currentDir, (err, files) => {
    ...
    files.forEach(file => copyFile(file, currentDir, destinationDir));
  });
}

export function copyFile(filename:string, currentDir:string, destinationDir:string) {
